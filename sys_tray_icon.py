...
class SysTrayIcon(object):
    ...
    def notify(self, hwnd, msg, wparam, lparam):
        if lparam==win32con.WM_LBUTTONDBLCLK:
            ...
            # 显示窗口 add by skywatcher@16-01-23
            import ctypes
            if self.wnd != 0:
                if ctypes.windll.user32.IsWindowVisible(self.wnd):
                    ctypes.windll.user32.ShowWindow(self.wnd, win32con.SW_HIDE)
                else:
                    # 显示窗口
                    ctypes.windll.user32.ShowWindow(self.wnd, win32con.SW_SHOW)
        return True
